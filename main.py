...
def separate_detailed_vocals(file_path):
    """
    [Beat, Vocals]
    Vocals -> [Backing, Reverb, Delay, Clean Vocals]
    """
...
def main():
    ...
    parser.add_argument('level', type=str, choices=['basic', 'intermediate', 'detailed', 'detailed_vocals'], help='Level of separation')
    ...
    elif args.level == 'detailed_vocals':
        result = separate_detailed_vocals(args.path)
    else:
